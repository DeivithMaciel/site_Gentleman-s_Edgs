  ...
  return (
    <S.Container id="products">
      ...
      <section className="container">
        <S.ButtonList>
          <a className={activeList === 'pomades' ? 'active' : ''} onClick={() => setActiveList('pomades')}>Pomades</a>
          <a className={activeList === 'beard' ? 'active' : ''} onClick={() => setActiveList('beard')}>Beard Care</a>
          <a className={activeList === 'tools' ? 'active' : ''} onClick={() => setActiveList('tools')}>Tools</a>
        </S.ButtonList>
        <S.List>
          {
            items.map(product => (
